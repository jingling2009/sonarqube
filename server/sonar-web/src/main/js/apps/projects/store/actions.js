...
const PAGE_SIZE = 50;
const PAGE_SIZE_VISUALIZATIONS = 500;
...
const METRICS_BY_VISUALIZATION = {
  // x, y, size
  bugs: ['ncloc', 'reliability_remediation_effort', 'bugs'],
  vulnerabilities: ['ncloc', 'security_remediation_effort', 'vulnerabilities'],
  code_smells: ['ncloc', 'sqale_index', 'code_smells'],
